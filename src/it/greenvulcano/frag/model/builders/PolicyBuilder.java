...
public class PolicyBuilder extends Builder {
    ...
    final String OUTPUT_BASE_PATH = PathResolver.get(Main.BASE_PATH, "GVPolicy");
    ...
    public void remake(Document gvfrag, String path) throws ParserConfigurationException, SAXException, IOException {
        Node policy = Utils.fileToDocument(new java.io.File(PathResolver.get(path, "GVPolicy", "GVPolicy.xml"))).getFirstChild();
